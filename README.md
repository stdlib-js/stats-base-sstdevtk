...
```javascript
import sstdevtk from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevtk@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-sstdevtk/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-base-sstdevtk/actions/workflows/test.yml?query=branch:v0.1.1
